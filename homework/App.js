...
function Home() {
  let products = [ 
    { id: 0, name: "닌텐도 스위치", price: "360,000"},
    { id: 1, name: "노트북", price: "1,330,000"},
    { id: 2, name: "스마트폰", price: "770,000"},
    { id: 3, name: "오디오 스피커", price: "120,000" },
    { id: 4, name: "플레이스테이션", price: "330,000"},
    { id: 5, name: "보조배터리", price: "55,000" },
    { id: 6, name: "컴퓨터 모니터", price: "190,000"},
    { id: 7, name: "헤드폰", price: "170,000" }    
  ]
  return (
      <div className="home">
          <Home_Header/>
          {products.map(p => <Product_Lists id={p.id} name={p.name} price={p.price} />)}
          <Home_Footer/>
      </div>
  );
}
